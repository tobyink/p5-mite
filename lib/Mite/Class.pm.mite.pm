...
sub new {
    ...
    my @unknown = grep not( /\A(?:attributes|constants|extends|name|parents|roles|source)\z/ ), keys %{$args}; @unknown and require Carp and Carp::croak("Unexpected keys in constructor: " . join(q[, ], sort @unknown));
