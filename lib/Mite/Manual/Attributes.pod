...
is the hash key used to store the attribute. It is the maintainer of Mite's
opinion that it is acceptable for an object method to directly access its
own attributes this way, but not attributes defined in roles, parent classes,
etc. Bypassing accessors will cause type checks, lazy defaults, triggers, etc
to be ignored, so should be done with caution.
...
=head2 C<reader> B<< MethodNameTemplate | One | Undef >>
...
=head2 C<writer> B<< MethodNameTemplate | One | Undef >>
...
=head2 C<accessor> B<< MethodNameTemplate | One | Undef >>
...
=head2 C<clearer> B<< MethodNameTemplate | One | Undef >>
...
=head2 C<predicate> B<< MethodNameTemplate | One | Undef >>
...
=head2 C<lvalue> B<< MethodNameTemplate | One | Undef >>
...
=head2 C<local_writer> B<< MethodNameTemplate | One | Undef >>
...
=head2 C<skip_argc_check> B<Bool>
...
=head2 C<handles> B<< Map[ MethodNameTemplate, MethodName ] | Enum[ 1, 2 ] >>
...
=head2 C<init_arg> B<< NonEmptyStr | Undef >>
...
=head2 C<alias> B<< ArrayRef[ MethodNameTemplate ] >>
...
=head2 C<enum> B<< ArrayRef[NonEmptyStr] >>
...
=head2 C<trigger> B<< MethodNameTemplate | One | CodeRef >>
...
=head2 C<clone> B<< MethodNameTemplate | One | CodeRef | Undef >>
...
=head2 C<default> B<< CodeRef | ScalarRef | Str | Undef | Dict[] | Tuple[] >>
...
=head2 C<builder> B<< MethodNameTemplate | One | CodeRef >>
...
=head2 C<default_is_trusted> B<Bool>
...
=head2 C<default_does_trigger> B<Bool>
