...
Mite doesn't support native attribute traits (i.e. delegating to non-objects).
However, you can accomplish this by using L<Sub::HandlesVia> 0.026 or above.
You need to make sure the Mite shim is loaded I<before> Sub::HandlesVia, and
this will add an extra dependency to your project.
