...
package Acme::Mitey::Cards::Types::Compiled;
...
BEGIN {
	package Acme::Mitey::Cards::Types::Compiled::TypeConstraint;
	our $LIBRARY = "Acme::Mitey::Cards::Types::Compiled";
...
# Any
{
	my $type;
	sub Any () {
		$type ||= bless( [ \&is_Any, "Any", "Types::Standard", "Any" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# ArrayRef
{
	my $type;
	sub ArrayRef () {
		$type ||= bless( [ \&is_ArrayRef, "ArrayRef", "Types::Standard", "ArrayRef" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Bool
{
	my $type;
	sub Bool () {
		$type ||= bless( [ \&is_Bool, "Bool", "Types::Standard", "Bool" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Card
{
	my $type;
	sub Card () {
		$type ||= bless( [ \&is_Card, "Card", "Acme::Mitey::Cards::Types", "Card" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# CardArray
{
	my $type;
	sub CardArray () {
		$type ||= bless( [ \&is_CardArray, "CardArray", "Acme::Mitey::Cards::Types", "CardArray" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# CardNumber
{
	my $type;
	sub CardNumber () {
		$type ||= bless( [ \&is_CardNumber, "CardNumber", "Acme::Mitey::Cards::Types", "CardNumber" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Character
{
	my $type;
	sub Character () {
		$type ||= bless( [ \&is_Character, "Character", "Acme::Mitey::Cards::Types", "Character" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# ClassName
{
	my $type;
	sub ClassName () {
		$type ||= bless( [ \&is_ClassName, "ClassName", "Types::Standard", "ClassName" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# CodeRef
{
	my $type;
	sub CodeRef () {
		$type ||= bless( [ \&is_CodeRef, "CodeRef", "Types::Standard", "CodeRef" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# ConsumerOf
{
	my $type;
	sub ConsumerOf () {
		$type ||= bless( [ \&is_ConsumerOf, "ConsumerOf", "Types::Standard", "ConsumerOf" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# CycleTuple
{
	my $type;
	sub CycleTuple () {
		$type ||= bless( [ \&is_CycleTuple, "CycleTuple", "Types::Standard", "CycleTuple" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Deck
{
	my $type;
	sub Deck () {
		$type ||= bless( [ \&is_Deck, "Deck", "Acme::Mitey::Cards::Types", "Deck" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Defined
{
	my $type;
	sub Defined () {
		$type ||= bless( [ \&is_Defined, "Defined", "Types::Standard", "Defined" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Dict
{
	my $type;
	sub Dict () {
		$type ||= bless( [ \&is_Dict, "Dict", "Types::Standard", "Dict" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Enum
{
	my $type;
	sub Enum () {
		$type ||= bless( [ \&is_Enum, "Enum", "Types::Standard", "Enum" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# FaceCard
{
	my $type;
	sub FaceCard () {
		$type ||= bless( [ \&is_FaceCard, "FaceCard", "Acme::Mitey::Cards::Types", "FaceCard" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# FileHandle
{
	my $type;
	sub FileHandle () {
		$type ||= bless( [ \&is_FileHandle, "FileHandle", "Types::Standard", "FileHandle" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# GlobRef
{
	my $type;
	sub GlobRef () {
		$type ||= bless( [ \&is_GlobRef, "GlobRef", "Types::Standard", "GlobRef" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Hand
{
	my $type;
	sub Hand () {
		$type ||= bless( [ \&is_Hand, "Hand", "Acme::Mitey::Cards::Types", "Hand" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# HasMethods
{
	my $type;
	sub HasMethods () {
		$type ||= bless( [ \&is_HasMethods, "HasMethods", "Types::Standard", "HasMethods" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# HashRef
{
	my $type;
	sub HashRef () {
		$type ||= bless( [ \&is_HashRef, "HashRef", "Types::Standard", "HashRef" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# InstanceOf
{
	my $type;
	sub InstanceOf () {
		$type ||= bless( [ \&is_InstanceOf, "InstanceOf", "Types::Standard", "InstanceOf" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Int
{
	my $type;
	sub Int () {
		$type ||= bless( [ \&is_Int, "Int", "Types::Standard", "Int" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# IntRange
{
	my $type;
	sub IntRange () {
		$type ||= bless( [ \&is_IntRange, "IntRange", "Types::Common::Numeric", "IntRange" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Item
{
	my $type;
	sub Item () {
		$type ||= bless( [ \&is_Item, "Item", "Types::Standard", "Item" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# JokerCard
{
	my $type;
	sub JokerCard () {
		$type ||= bless( [ \&is_JokerCard, "JokerCard", "Acme::Mitey::Cards::Types", "JokerCard" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# LaxNum
{
	my $type;
	sub LaxNum () {
		$type ||= bless( [ \&is_LaxNum, "LaxNum", "Types::Standard", "LaxNum" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# LowerCaseSimpleStr
{
	...
	sub LowerCaseSimpleStr () {
		$type ||= bless( [ \&is_LowerCaseSimpleStr, "LowerCaseSimpleStr", "Types::Common::String", "LowerCaseSimpleStr" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# LowerCaseStr
{
	my $type;
	sub LowerCaseStr () {
		$type ||= bless( [ \&is_LowerCaseStr, "LowerCaseStr", "Types::Common::String", "LowerCaseStr" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Map
{
	my $type;
	sub Map () {
		$type ||= bless( [ \&is_Map, "Map", "Types::Standard", "Map" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Maybe
{
	my $type;
	sub Maybe () {
		$type ||= bless( [ \&is_Maybe, "Maybe", "Types::Standard", "Maybe" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# NegativeInt
{
	my $type;
	sub NegativeInt () {
		$type ||= bless( [ \&is_NegativeInt, "NegativeInt", "Types::Common::Numeric", "NegativeInt" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# NegativeNum
{
	my $type;
	sub NegativeNum () {
		$type ||= bless( [ \&is_NegativeNum, "NegativeNum", "Types::Common::Numeric", "NegativeNum" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# NegativeOrZeroInt
{
	...
	sub NegativeOrZeroInt () {
		$type ||= bless( [ \&is_NegativeOrZeroInt, "NegativeOrZeroInt", "Types::Common::Numeric", "NegativeOrZeroInt" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# NegativeOrZeroNum
{
	...
	sub NegativeOrZeroNum () {
		$type ||= bless( [ \&is_NegativeOrZeroNum, "NegativeOrZeroNum", "Types::Common::Numeric", "NegativeOrZeroNum" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# NonEmptySimpleStr
{
	...
	sub NonEmptySimpleStr () {
		$type ||= bless( [ \&is_NonEmptySimpleStr, "NonEmptySimpleStr", "Types::Common::String", "NonEmptySimpleStr" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# NonEmptyStr
{
	my $type;
	sub NonEmptyStr () {
		$type ||= bless( [ \&is_NonEmptyStr, "NonEmptyStr", "Types::Common::String", "NonEmptyStr" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Num
{
	my $type;
	sub Num () {
		$type ||= bless( [ \&is_Num, "Num", "Types::Standard", "Num" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# NumRange
{
	my $type;
	sub NumRange () {
		$type ||= bless( [ \&is_NumRange, "NumRange", "Types::Common::Numeric", "NumRange" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# NumericCard
{
	my $type;
	sub NumericCard () {
		$type ||= bless( [ \&is_NumericCard, "NumericCard", "Acme::Mitey::Cards::Types", "NumericCard" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# NumericCode
{
	my $type;
	sub NumericCode () {
		$type ||= bless( [ \&is_NumericCode, "NumericCode", "Types::Common::String", "NumericCode" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Object
{
	my $type;
	sub Object () {
		$type ||= bless( [ \&is_Object, "Object", "Types::Standard", "Object" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# OptList
{
	my $type;
	sub OptList () {
		$type ||= bless( [ \&is_OptList, "OptList", "Types::Standard", "OptList" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Optional
{
	my $type;
	sub Optional () {
		$type ||= bless( [ \&is_Optional, "Optional", "Types::Standard", "Optional" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Overload
{
	my $type;
	sub Overload () {
		$type ||= bless( [ \&is_Overload, "Overload", "Types::Standard", "Overload" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Password
{
	my $type;
	sub Password () {
		$type ||= bless( [ \&is_Password, "Password", "Types::Common::String", "Password" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# PositiveInt
{
	my $type;
	sub PositiveInt () {
		$type ||= bless( [ \&is_PositiveInt, "PositiveInt", "Types::Common::Numeric", "PositiveInt" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# PositiveNum
{
	my $type;
	sub PositiveNum () {
		$type ||= bless( [ \&is_PositiveNum, "PositiveNum", "Types::Common::Numeric", "PositiveNum" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# PositiveOrZeroInt
{
	...
	sub PositiveOrZeroInt () {
		$type ||= bless( [ \&is_PositiveOrZeroInt, "PositiveOrZeroInt", "Types::Common::Numeric", "PositiveOrZeroInt" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# PositiveOrZeroNum
{
	...
	sub PositiveOrZeroNum () {
		$type ||= bless( [ \&is_PositiveOrZeroNum, "PositiveOrZeroNum", "Types::Common::Numeric", "PositiveOrZeroNum" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Ref
{
	my $type;
	sub Ref () {
		$type ||= bless( [ \&is_Ref, "Ref", "Types::Standard", "Ref" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# RegexpRef
{
	my $type;
	sub RegexpRef () {
		$type ||= bless( [ \&is_RegexpRef, "RegexpRef", "Types::Standard", "RegexpRef" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# RoleName
{
	my $type;
	sub RoleName () {
		$type ||= bless( [ \&is_RoleName, "RoleName", "Types::Standard", "RoleName" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# ScalarRef
{
	my $type;
	sub ScalarRef () {
		$type ||= bless( [ \&is_ScalarRef, "ScalarRef", "Types::Standard", "ScalarRef" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Set
{
	my $type;
	sub Set () {
		$type ||= bless( [ \&is_Set, "Set", "Acme::Mitey::Cards::Types", "Set" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# SimpleStr
{
	my $type;
	sub SimpleStr () {
		$type ||= bless( [ \&is_SimpleStr, "SimpleStr", "Types::Common::String", "SimpleStr" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# SingleDigit
{
	my $type;
	sub SingleDigit () {
		$type ||= bless( [ \&is_SingleDigit, "SingleDigit", "Types::Common::Numeric", "SingleDigit" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Str
{
	my $type;
	sub Str () {
		$type ||= bless( [ \&is_Str, "Str", "Types::Standard", "Str" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# StrLength
{
	my $type;
	sub StrLength () {
		$type ||= bless( [ \&is_StrLength, "StrLength", "Types::Common::String", "StrLength" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# StrMatch
{
	my $type;
	sub StrMatch () {
		$type ||= bless( [ \&is_StrMatch, "StrMatch", "Types::Standard", "StrMatch" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# StrictNum
{
	my $type;
	sub StrictNum () {
		$type ||= bless( [ \&is_StrictNum, "StrictNum", "Types::Standard", "StrictNum" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# StringOrObject
{
	my $type;
	sub StringOrObject () {
		$type ||= bless( [ \&is_StringOrObject, "StringOrObject", "Acme::Mitey::Cards::Types", "StringOrObject" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# StrongPassword
{
	my $type;
	sub StrongPassword () {
		$type ||= bless( [ \&is_StrongPassword, "StrongPassword", "Types::Common::String", "StrongPassword" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Suit
{
	my $type;
	sub Suit () {
		$type ||= bless( [ \&is_Suit, "Suit", "Acme::Mitey::Cards::Types", "Suit" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Tied
{
	my $type;
	sub Tied () {
		$type ||= bless( [ \&is_Tied, "Tied", "Types::Standard", "Tied" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Tuple
{
	my $type;
	sub Tuple () {
		$type ||= bless( [ \&is_Tuple, "Tuple", "Types::Standard", "Tuple" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Undef
{
	my $type;
	sub Undef () {
		$type ||= bless( [ \&is_Undef, "Undef", "Types::Standard", "Undef" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# UpperCaseSimpleStr
{
	...
	sub UpperCaseSimpleStr () {
		$type ||= bless( [ \&is_UpperCaseSimpleStr, "UpperCaseSimpleStr", "Types::Common::String", "UpperCaseSimpleStr" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# UpperCaseStr
{
	my $type;
	sub UpperCaseStr () {
		$type ||= bless( [ \&is_UpperCaseStr, "UpperCaseStr", "Types::Common::String", "UpperCaseStr" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
# Value
{
	my $type;
	sub Value () {
		$type ||= bless( [ \&is_Value, "Value", "Types::Standard", "Value" ], "Acme::Mitey::Cards::Types::Compiled::TypeConstraint" );
	}
...
Acme::Mitey::Cards::Types::Compiled - type constraint library
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Any );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :ArrayRef );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Bool );

=head2 B<Card>

Based on B<Card> in L<Acme::Mitey::Cards::Types>.
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Card );

=head2 B<CardArray>

Based on B<CardArray> in L<Acme::Mitey::Cards::Types>.
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :CardArray );

=head2 B<CardNumber>

Based on B<CardNumber> in L<Acme::Mitey::Cards::Types>.
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :CardNumber );

=head2 B<Character>

Based on B<Character> in L<Acme::Mitey::Cards::Types>.
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Character );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :ClassName );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :CodeRef );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :ConsumerOf );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :CycleTuple );

=head2 B<Deck>

Based on B<Deck> in L<Acme::Mitey::Cards::Types>.
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Deck );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Defined );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Dict );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Enum );

=head2 B<FaceCard>

Based on B<FaceCard> in L<Acme::Mitey::Cards::Types>.
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :FaceCard );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :FileHandle );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :GlobRef );

=head2 B<Hand>

Based on B<Hand> in L<Acme::Mitey::Cards::Types>.
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Hand );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :HasMethods );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :HashRef );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :InstanceOf );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Int );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :IntRange );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Item );

=head2 B<JokerCard>

Based on B<JokerCard> in L<Acme::Mitey::Cards::Types>.
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :JokerCard );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :LaxNum );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :LowerCaseSimpleStr );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :LowerCaseStr );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Map );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Maybe );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :NegativeInt );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :NegativeNum );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :NegativeOrZeroInt );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :NegativeOrZeroNum );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :NonEmptySimpleStr );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :NonEmptyStr );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Num );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :NumRange );

=head2 B<NumericCard>

Based on B<NumericCard> in L<Acme::Mitey::Cards::Types>.
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :NumericCard );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :NumericCode );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Object );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :OptList );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Optional );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Overload );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Password );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :PositiveInt );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :PositiveNum );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :PositiveOrZeroInt );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :PositiveOrZeroNum );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Ref );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :RegexpRef );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :RoleName );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :ScalarRef );

=head2 B<Set>

Based on B<Set> in L<Acme::Mitey::Cards::Types>.
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Set );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :SimpleStr );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :SingleDigit );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Str );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :StrLength );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :StrMatch );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :StrictNum );

=head2 B<StringOrObject>

Based on B<StringOrObject> in L<Acme::Mitey::Cards::Types>.

The C<< StringOrObject >> constant returns a blessed type constraint object.
C<< is_StringOrObject($value) >> checks a value against the type and returns a boolean.
C<< assert_StringOrObject($value) >> checks a value against the type and throws an error.

To import all of these functions:

  use Acme::Mitey::Cards::Types::Compiled qw( :StringOrObject );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :StrongPassword );

=head2 B<Suit>

Based on B<Suit> in L<Acme::Mitey::Cards::Types>.
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Suit );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Tied );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Tuple );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Undef );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :UpperCaseSimpleStr );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :UpperCaseStr );
...
To import all of these functions:
  ...
  use Acme::Mitey::Cards::Types::Compiled qw( :Value );
